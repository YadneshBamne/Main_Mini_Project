...
const page = () => {
  return (
    <div className="min-h-screen bg-gray-800 justify-center items-center  ">
     ...
     <div className="flex justify-center h-auto min-w-screen">
      ...
      <Carousel className="bg-gray-800 text-white ml-auto mr-auto text-center flex items-center justify-center h-96 w-96 ">
